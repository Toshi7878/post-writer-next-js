  ...
  return (
    <>
      ...
      >
        <div className="text-center space-y-6 max-w-[58rem] mx-auto">
          ...
          <p className="text-muted-foreground sm:text-lg sm:leading-7">
            ...
            AppRouterやcontentlayerを利用してブログ投稿ができます。
          </p>
        </div>
      ...
      <section id="contact" className="container py-8 md:py-12 lg:py-24">
        <div className="max-w-[58rem] mx-auto text-center space-y-3 flex flex-col gap-4">
          ...
          <Link
            href={siteConfig.links.x}
            className="underline underilne-offset-4"
            target="_blank"
            rel="noreferrer"
          >
            お仕事はXまで
